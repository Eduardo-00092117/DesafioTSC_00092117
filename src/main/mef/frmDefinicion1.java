 ...
 * @author Eduardo
 */
public class frmDefinicion1 extends javax.swing.JFrame {

    /**
     * Creates new form frmPaso1
     */
    public frmDefinicion1() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Mef/Definicion de elementos - 1.png"))); // NOI18N
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 90, 520, 570));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDefinicion1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDefinicion1().setVisible(true);
            }
        });
    }
